...
#    ActiveSupport::Notifications.instrument 'wagn.per_request_setup', :message=>"" do
      ...
      #warn "set curent_user (app-cont) #{self.session_card_id}, U.cu:#{Account.user_card_id}"
      Account.user_card_id = self.session_card_id || Card::AnonID
      #warn "set curent_user a #{session_card_id}, U.cu:#{Account.user_card_id}"
